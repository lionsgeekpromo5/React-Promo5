      ...
      <div className='flex flex-wrap gap-5 p-4'>
        {
            products.map((prod, id) => (
                <div className='w-[20vw] h-[50vh] border-2 border-gray-400 rounded-lg'>
                    <img src={prod.images} alt="" className='w-full h-[60%] object-contain border-b-1 border-green-500' />
                    <div className='flex flex-col gap-y-2 p-2'>
                        <span className='text-xl font-bold truncate'>{prod.title}</span>
                        <div className='flex items-center gap-x-2'>
                            {
                            prod.tags.map(tag => (
                                <span className='bg-amber-400 rounded-full px-2 text-white'>{tag}</span>
                            ))
                        }
                        </div>
                        <button onClick={() => navigate(`/products/${prod.id}`) } className='bg-green-700 px-4 py-2 rounded-lg w-fit text-white'>See Details</button>
                    </div>
